    ...
    <div class="card shadow-sm">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="profilTable" class="table table-bordered table-hover text-center">
                  ...
                  <tr>
                    <td>
                      <?php if ($profile['photo']) : ?>
                        <img src="<?= base_url('uploads/photos/' . $profile['photo']) ?>" class="img-thumbnail" width="70" alt="Foto">
                      <?php else : ?>
